...
if FLAG_R400:
    ...
    outputdata_csv = "R400_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.csv"
    outputdata_fits = "R400_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.fits"

elif FLAG_R300:
    df = df_R300
    disperser_name="Ronchi 300"
    outputdata_csv = "R300_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.csv"
    outputdata_fits = "R300_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.fits"


elif FLAG_R350:
    df = df_R350
    disperser_name="Ronchi 350"
    outputdata_csv = "R350_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.csv"
    outputdata_fits = "R350_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.fits"

elif FLAG_R200:
    df = df_R200
    disperser_name="Ronchi 200"
    outputdata_csv = "R200_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.csv"
    outputdata_fits = "R200_RESAMPLEBEAM_" + Beam4_Rayfile + "_out.fits"
